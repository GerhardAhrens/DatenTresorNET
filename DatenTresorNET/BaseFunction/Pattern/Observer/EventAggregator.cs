/*
 * <copyright file="EventAggregator.cs" company="Lifeprojects.de">
 ...
 *
 * <summary>
 * Implementierung der Klasse EventAggregator
 * </summary>
 *
...
namespace DatenTresorNET.BaseFunction.Pattern
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        public bool ExistKey<TPayload>() where TPayload : IPayload
        {
            bool result = false;
            Type messageType = typeof(TPayload);
        ...
        public int CountValues<TPayload>() where TPayload : IPayload
        {
            int result = 0;
            Type messageType = typeof(TPayload);
